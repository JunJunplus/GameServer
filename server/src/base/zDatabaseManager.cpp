...
//soke вов╟
zDataBM<zPurpleObjectB,PurpleObjectBase> &purpleobjectbm=zDataBM<zPurpleObjectB,PurpleObjectBase>::getMe();
...
bool loadAllBM()
{
	...
	//soke вов╟
	if(!purpleobjectbm.refresh((Zebra::global["tbldir"] + "/PurpleObjectBase.tbl").c_str())) return false;
